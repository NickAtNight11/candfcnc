    ...
    <div id="footer">
        ...
        <div id="footer-bottom">
            <div className='footer-column'>
                ...
                <h5 className='left-text'>
                    <i>Background by<br/>
                    <a href="https://www.pexels.com/@fwstudio-33348?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels" target="_blank" rel="noreferrer">FWStudio from Pexels</a></i>
                </h5>
            </div>
            <div id='center-column' className='footer-column'>
                <h4><i>C & F CNC and Laser Creations</i></h4>
